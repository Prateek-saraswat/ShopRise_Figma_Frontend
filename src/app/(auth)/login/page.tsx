  ...
  return (
    <div className="min-h-screen flex bg-[#1F3A93]">
            ...
            <div className="flex flex-col items-center gap-[15px]">
              ...
              <div className="flex flex-col items-center gap-5">
                ...
                <p className="text-[14px] text-[#333333] leading-[17px]">
                  Don't have account?{' '}
                  <a href="/signup" className="text-[#1F3A93] hover:underline">
                    Sign up here
                  </a>
                </p>
              </div>
              ...
              >
                ...
                <span className="text-[14px] font-medium text-[#333333] leading-[17px]">Sign in with Google</span>
              </button>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-[14px]">
                  <button
                    ...
                    className={`w-[18px] h-[18px] rounded-[3px] border flex items-center justify-center transition-all ${
                      rememberMe 
                        ? 'bg-[#1F3A93] border-[#1F3A93]' 
                        : 'bg-[#D9D9D9] border-[#D3D3D3] hover:border-[#1F3A93]'
                    }`}
                  >
                    {rememberMe && (
                  ...
                  <span className="text-[14px] text-[#333333] leading-[17px]">Remember me</span>
                </div>
                <a href="/forgot-password" className="text-[14px] font-medium text-[#1F3A93] leading-[17px] underline hover:text-[#152a6d] transition-colors">
                  Forgot password
                </a>
              </div>
            </div>
      ...
      <div 
        ...
        style={{
          backgroundImage: 'linear-gradient(rgba(31, 58, 147, 0.2), rgba(31, 58, 147, 0.2)), url("/loginImg.jpg")',
        }}
      />
    </div>
  )
