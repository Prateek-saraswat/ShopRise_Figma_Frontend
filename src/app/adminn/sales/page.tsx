  ...
  const orders: Order[] = [
    {
      ...
      customer: { name: 'Jackson Smith', avatar: '/customer-avatar.jpg' },
    ...
    >
      ...
      >
        ...
        >
          ...
          <div style={{ width: '53px', height: '0px', border: '1px solid #1F3A93' }} />
        </div>
      ...
      >
        ...
        <div 
          className="flex flex-col gap-[10px] items-end"
        >
          {/* Search Bar */}
          <div 
            className="flex items-center"
        ...
        >
          ...
          >
            ...
            <span style={{ width: '155px', fontFamily: 'Inter', fontWeight: 400, fontSize: '14px', lineHeight: '17px', color: '#000000' }}>Customer</span>
