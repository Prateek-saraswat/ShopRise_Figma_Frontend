    ...
    <div className="flex h-screen bg-white">
      ...
      <div className="flex-1 p-6 overflow-auto">
        ...
        <div className="mb-8">
          ...
          <div className="flex flex-wrap gap-x-5 gap-y-[35px] p-5">
            <div className="flex items-center gap-[10px] w-[230px]">
        ...
        <div className="mb-8">
          ...
          <div className="flex flex-wrap gap-x-5 gap-y-[35px] p-5">
            <div className="flex flex-col px-[10px] gap-[3px] w-[230px]">
              <div className="flex flex-col gap-[5px]">
                <span className="text-[30px] font-medium text-gray-800">0%</span>
